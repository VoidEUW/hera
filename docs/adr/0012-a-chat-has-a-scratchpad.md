...
artifacts ([ADR 13](0013-an-artifact-is-a-file-she-publishes.md)), the sandbox's working
...
**Nobody reads it, and that is a property worth defending.** It is what lets her think out loud
here without being tidy. [ADR 13](0013-an-artifact-is-a-file-she-publishes.md) therefore gives
what she *publishes* a directory of its own next door rather than a flag in this one — a scratchpad
a person browses for the deliverable is not a scratchpad.
