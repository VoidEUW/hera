...
| # | Decision | Status |
|---|---|---|
| [1](0001-uv-workspace-monorepo.md) | A uv-workspace monorepo, with two foundation libraries kept outside | accepted |
...
| [6](0006-spa-over-json-sse-api.md) | A SvelteKit application over a JSON and SSE API | accepted |
