    ...
    *,
    ...
    @server.tool(
        ...
        description=(
            ...
            "page, `.svg` and `.mmd` draw, `.md` is typeset, anything else is shown as code. "
            "For a diagram -- a flow, a sequence, a state machine, an entity model -- write "
            "mermaid in a `.mmd` rather than drawing it by hand in SVG: it is drawn the same "
            "way and it is far easier to get right. Publishing "
